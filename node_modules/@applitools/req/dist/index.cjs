...
var require_common2 = __commonJS({
  "../../node_modules/agent-base/node_modules/debug/src/common.js"(exports, module2) {
    function setup(env) {
      createDebug.debug = createDebug;
      createDebug.default = createDebug;
      createDebug.coerce = coerce;
...
var require_browser2 = __commonJS({
  "../../node_modules/agent-base/node_modules/debug/src/browser.js"(exports, module2) {
    exports.formatArgs = formatArgs;
    exports.save = save;
    exports.load = load;
    exports.useColors = useColors;
...
var require_node2 = __commonJS({
  "../../node_modules/agent-base/node_modules/debug/src/node.js"(exports, module2) {
    var tty = require("tty");
    var util = require("util");
    exports.init = init;
    exports.log = log;
...
var require_src2 = __commonJS({
  "../../node_modules/agent-base/node_modules/debug/src/index.js"(exports, module2) {
    if (typeof process === "undefined" || process.type === "renderer" || process.browser === true || process.__nwjs) {
...
function makeAgent({ proxy, useDnsCache }) {
  return function agent(url) {
    ...
    if (proxyOptions) {
      ...
      return new import_https.Agent({ rejectUnauthorized: false, lookup: lookup2 });
    } else if (url.protocol === "http:") {
      return new import_http.Agent({ lookup: lookup2 });
    }
  };
}
...
async function req(input, ...requestOptions) {
  ...
  async function req2(input2, options2) {
    ...
    let request = new Request(url, {
      ...
      agent: makeAgent({ proxy: options2.proxy, useDnsCache: options2.useDnsCache }),
    ...
    try {
      ...
      if (retry) {
        ...
        const delay = response.headers.has("Retry-After") ? Number(response.headers.get("Retry-After")) * 1e3 : utils3.types.isArray(retry.timeout) ? retry.timeout[Math.min(retry.attempt, retry.timeout.length - 1)] : (_j = retry.timeout) !== null && _j !== void 0 ? _j : 0;
      ...
      if (retry) {
        ...
        const delay = utils3.types.isArray(retry.timeout) ? retry.timeout[Math.min(retry.attempt, retry.timeout.length)] : (_m = retry.timeout) !== null && _m !== void 0 ? _m : 0;
        await utils3.general.sleep(delay);
